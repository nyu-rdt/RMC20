...
- **Value: 252** is a "ping" value. When a command with 252 as the offset is sent to the robot, the drive subsystem will perform a diagnostic and respond with some data to let the server know it is live.
