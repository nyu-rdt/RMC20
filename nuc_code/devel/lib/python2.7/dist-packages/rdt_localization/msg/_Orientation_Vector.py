...
class Orientation_Vector(genpy.Message):
  _md5sum = "32c0233ad09fff327409092d7163201c"
...
float32 x
float32 y"""
  __slots__ = ['robot_pose','target_zone','robot_speed']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       robot_pose,target_zone,robot_speed
    ...
    if args or kwds:
      ...
      if self.target_zone is None:
        self.target_zone = rdt_localization.msg.Location()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5fq().pack(_x.robot_pose.x, _x.robot_pose.y, _x.robot_pose.orientation, _x.target_zone.x, _x.target_zone.y, _x.robot_speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robot_pose.x, _x.robot_pose.y, _x.robot_pose.orientation, _x.target_zone.x, _x.target_zone.y, _x.robot_speed,) = _get_struct_5fq().unpack(str[start:end])
      return self
