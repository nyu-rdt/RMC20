...
(cl:ensure-generic-function 'dig_zone-val :lambda-list '(m))
(cl:defmethod dig_zone-val ((m <Orientation_Vector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rdt_localization-msg:dig_zone-val is deprecated.  Use rdt_localization-msg:dig_zone instead.")
  (dig_zone m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Orientation_Vector>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'dig_zone) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Orientation_Vector>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'dig_zone) istream)
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Orientation_Vector>)))
  ...
  "09467e8e0e560bedfd1a1c32cc5278c6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Orientation_Vector)))
  "Returns md5sum for a message object of type 'Orientation_Vector"
  "09467e8e0e560bedfd1a1c32cc5278c6")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Orientation_Vector>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'dig_zone))
     8
))
